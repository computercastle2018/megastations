...
import 'package:mega/common/widgets/demo_reset_dialog_widget.dart';
import 'package:mega/common/widgets/taxi_make_payment_bottomsheet.dart';
import 'package:mega/features/chat/controllers/chat_controller.dart';
import 'package:mega/features/chat/enums/user_type_enum.dart';
...
import 'package:mega/features/rental_module/rental_order/screens/taxi_order_details_screen.dart';
...
import 'package:mega/features/notification/widgets/notifiation_popup_dialog_widget.dart';
...
class NotificationHelper {
  ...
  static Future<void> initialize(FlutterLocalNotificationsPlugin flutterLocalNotificationsPlugin) async {
    ...
    final AndroidFlutterLocalNotificationsPlugin? androidFln = flutterLocalNotificationsPlugin
        .resolvePlatformSpecificImplementation<AndroidFlutterLocalNotificationsPlugin>();
    androidFln?.requestNotificationsPermission();


    const AndroidNotificationChannel megaChannel = AndroidNotificationChannel(
      'megastation', AppConstants.appName,
      description: 'Default channel for MegaStation notifications',
      importance: Importance.max,
      sound: RawResourceAndroidNotificationSound('notification'),
    );
    await androidFln?.createNotificationChannel(megaChannel);
  ...
  static Future<void> showTextNotification(String title, String body, String orderID, NotificationBodyModel? notificationBody, FlutterLocalNotificationsPlugin fln) async {
    const AndroidNotificationDetails androidPlatformChannelSpecifics = AndroidNotificationDetails(
      'megastation', AppConstants.appName, playSound: true,
  ...
  static Future<void> showBigTextNotification(String? title, String body, String? orderID, NotificationBodyModel? notificationBody, FlutterLocalNotificationsPlugin fln) async {
    ...
    AndroidNotificationDetails androidPlatformChannelSpecifics = AndroidNotificationDetails(
      'megastation', AppConstants.appName, importance: Importance.max,
