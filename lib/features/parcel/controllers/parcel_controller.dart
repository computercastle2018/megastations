...
import 'package:mega/features/parcel/domain/models/video_content_model.dart';
import 'package:mega/features/parcel/domain/models/why_choose_model.dart';
...
class ParcelController extends GetxController implements GetxService {
  ...
  void setInstructionSelectedIndex(int index, {bool notify = true}) {
    // If the same index is tapped again â†’ unselect
