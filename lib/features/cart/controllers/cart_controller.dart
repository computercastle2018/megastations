...
import 'package:mega/features/cart/domain/models/online_cart_model.dart';
...
class CartController extends GetxController implements GetxService {
  ...
  List<String> notAvailableList = ['Remove it from my cart', 'Iâ€™ll wait until itâ€™s restocked', 'Please cancel the order', 'Call me ASAP', 'Notify me when itâ€™s back'];
