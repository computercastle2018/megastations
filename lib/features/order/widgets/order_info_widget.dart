...
import 'package:mega/common/widgets/custom_card.dart';
...
import 'package:mega/features/review/domain/models/review_model.dart';
...
import 'package:mega/helper/string_extension.dart';
...
import 'package:mega/features/chat/widgets/image_dialog_widget.dart';
import 'package:mega/features/order/widgets/delivery_details_widget.dart';
import 'package:mega/features/payment/widgets/offline_info_edit_dialog_widget.dart';
import 'package:mega/features/order/widgets/order_banner_view_widget.dart';
import 'package:mega/features/order/widgets/order_item_widget.dart';
import 'package:mega/features/parcel/widgets/details_widget.dart';
import 'package:mega/features/review/widgets/review_dialog_widget.dart';
            ...
            order.deliveryInstruction != null ? Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              RichText(
                text: TextSpan(
                  ...
                  children: <TextSpan>[
                    TextSpan(text: order.deliveryInstruction?.tr ?? '', style: robotoRegular.copyWith(color: Theme.of(context).textTheme.bodyLarge?.color?.withValues(alpha: 0.6))),
                  ],
                ),
              ),
            ]) : const SizedBox(),
