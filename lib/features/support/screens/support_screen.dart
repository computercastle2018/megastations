...
import 'package:mega/features/support/widgets/web_help_support_widget.dart';
...
import 'package:mega/features/support/widgets/support_button_widget.dart';
      ...
      body: SingleChildScrollView(
        ...
        child: Center(child: FooterView(
          child: ResponsiveHelper.isDesktop(context) ? const SizedBox(
            ...
            SupportButtonWidget(
              icon: Icons.mail_outline, title: 'email_us'.tr, color: Theme.of(context).primaryColor,
