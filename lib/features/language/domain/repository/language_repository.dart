...
class LanguageRepository implements LanguageRepositoryInterface {
  ...
  Locale getLocaleFromSharedPref() {
    return Locale(sharedPreferences.getString(AppConstants.languageCode) ?? 'ar',
  ...
  Locale getCacheLocaleFromSharedPref() {
    return Locale(sharedPreferences.getString(AppConstants.cacheLanguageCode) ?? 'ar',
        sharedPreferences.getString(AppConstants.cacheCountryCode) ?? 'SA');
  }
