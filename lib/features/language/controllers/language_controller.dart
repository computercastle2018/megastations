...
class LocalizationController extends GetxController implements GetxService {
  ...
  void setLanguage(Locale locale, {bool fromBottomSheet = false}) {
    ...
    // Override currency symbol to official SAR sign for Arabic locale
    if(_locale.languageCode == 'ar') {
      Get.find<SplashController>().configModel?.currencySymbol = '﷼';
      Get.find<SplashController>().configModel?.currencySymbolDirection = 'left';
    }
  ...
  void loadCurrentLanguage() async {
    ...
    // Apply Arabic currency overrides on initial load
    if(_locale.languageCode == 'ar') {
      Get.find<SplashController>().configModel?.currencySymbol = '﷼';
      Get.find<SplashController>().configModel?.currencySymbolDirection = 'left';
    }
