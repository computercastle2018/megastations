...
import 'package:mega/features/menu/domain/models/menu_model.dart';
      ...
      child: Column(children: [
        ...
        Container(
          ...
          decoration: BoxDecoration(
            ...
            color: isLogout ? AuthHelper.isLoggedIn() ? Colors.red : Theme.of(context).primaryColor : Theme.of(context).primaryColor,
